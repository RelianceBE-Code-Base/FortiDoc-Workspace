  ...
  constructor(props: ComponentsGridProps) {
    ...
    this.state = {
      components: [
        ...
        { name: 'Announcement', component: Announcement, width: 'col-md-4', pinned: false, order: 3, isRemoved: false },
        { name: 'MicrosoftTeams', component: MicrosoftTeams, width: 'col-md-4', pinned: false, order: 4, isRemoved: true, msGraphClient: this.props.graphClient },
        { name: 'MicrosoftApps', component: MicrosoftApps, width: 'col-md-4', pinned: false, order: 5, isRemoved: true },
        { name: 'BusinessApps', component: BusinessApps, width: 'col-md-4', pinned: false, order: 6, isRemoved: true },
        { name: 'StaffDirectory', component: StaffDirectory, width: 'col-md-4', pinned: false, order: 7, isRemoved: true },
        { name: 'Task', component: Task, width: 'col-md-4', pinned: false, order: 8, isRemoved: true },
        { name: 'Calendar', component: Calendar, width: 'col-md-4', pinned: false, order: 9, isRemoved: true },
        { name: 'CompanyEvents', component: CompanyEvents, width: 'col-md-4', pinned: false, order: 10, isRemoved: true },
        { name: 'Birthday', component: Birthday, width: 'col-md-4', pinned: false, order: 11, isRemoved: true },
        { name: 'Anniversary', component: Anniversary, width: 'col-md-4', pinned: false, order: 12, isRemoved: true }
      ],
      userEmail: null,
    };
  }
