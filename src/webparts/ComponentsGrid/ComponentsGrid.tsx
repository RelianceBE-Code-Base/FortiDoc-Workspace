  ...
  constructor(props: ComponentsGridProps) {
    ...
    this.state = {
      components: [
        ...
        { name: 'MicrosoftTeams', component: MicrosoftTeams, width: 'col-md-4', pinned: false, order: 4, isRemoved: false, msGraphClient: this.props.graphClient },
        { name: 'MicrosoftApps', component: MicrosoftApps, width: 'col-md-4', pinned: false, order: 5, isRemoved: false },
        { name: 'BusinessApps', component: BusinessApps, width: 'col-md-4', pinned: false, order: 6, isRemoved: false },
        { name: 'StaffDirectory', component: StaffDirectory, width: 'col-md-4', pinned: false, order: 7, isRemoved: false },
        { name: 'Task', component: Task, width: 'col-md-4', pinned: false, order: 8, isRemoved: false },
        { name: 'Calendar', component: Calendar, width: 'col-md-4', pinned: false, order: 9, isRemoved: false },
        { name: 'CompanyEvents', component: CompanyEvents, width: 'col-md-4', pinned: false, order: 10, isRemoved: false },
